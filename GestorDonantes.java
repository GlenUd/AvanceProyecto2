...
public class GestorDonantes {
    ...
    public GestorDonantes() {
        donantes.add(new Donante("Ana Pérez",  "0102030405", "O+", 30, "Quito",      "2025-10-01"));
        donantes.add(new Donante("Luis Gómez", "1102233445", "A-", 40, "Guayaquil", "2025-09-15"));
        donantes.add(new Donante("María Ruiz","0912345678", "B+", 28, "Cuenca",     "2025-10-10"));
        donantes.add(new Donante("Carlos Vega","1723456789", "AB+",35,"Ambato",     "2025-08-30"));
        donantes.add(new Donante("Sofía León","0609876543", "O-", 25, "Quito",      "2025-10-05"));
    }
